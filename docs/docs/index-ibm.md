# Quarkus AI Hands-on Lab: From AI services to Agentic System

Welcome to the Quarkus AI Hands-on Lab! 
This hands-on lab will guide you through building **AI-infused applications** and **agentic systems** using **IBM Enterprise Build of Quarkus** and LangChain4j.
...
Throughout the hands-on lab, you will create an LLM-powered customer support chatbot for a car rental company.

The hands-on lab is divided into two sections:
...
- **Section 2 – Agentic systems (6 steps):**  
...
![Quarkus LangChain4j hands-on lab Architecture](images/global-architecture.png)
...
Once ready, you can pick one of these entries points to start the hands-on lab:
